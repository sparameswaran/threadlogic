...
public abstract class TokenMarker {
  ...
  public Token markTokens(Segment line, int lineIndex) {
     ...
     * same line is marked twice.
     * 
     * Why is this necessary? It's all JEditTextArea's fault. When something is
     * inserted into the text, firing a document event, the insertUpdate()
     ...
     * 
     * scrollTo() calls offsetToX(), which tokenizes the line unless it is being
     * called on the last line painted (in which case it uses the text area's
     ...
     * 
     * This bug took me ages to track down, that's why I wrote all the relevant
     * info down so that others wouldn't duplicate it.
     */
