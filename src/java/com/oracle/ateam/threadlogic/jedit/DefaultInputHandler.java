...
public class DefaultInputHandler extends InputHandler {
   ...
   *          key binding to add
   * @param action
   *          action to perform if key is pressed.
   */
  ...
  public void keyPressed(KeyEvent evt) {
    ...
    if ((modifiers & ~KeyEvent.SHIFT_MASK) != 0 || evt.isActionKey() || keyCode == KeyEvent.VK_BACK_SPACE
      ...
      if (o == null) {
        ...
        executeAction(((ActionListener) o), evt.getSource(), String.valueOf(evt.getKeyChar()), evt.getModifiers());
    ...
    if (c != KeyEvent.CHAR_UNDEFINED && (modifiers & KeyEvent.ALT_MASK) == 0) {
      if (c >= 0x20 && c != 0x7f) {
        ...
        if (o instanceof Hashtable) {
          ...
          currentBindings = bindings;
          executeAction((ActionListener) o, evt.getSource(), String.valueOf(c), modifiers);
          return;
        }
        ...
        executeAction(INSERT_CHAR, evt.getSource(), String.valueOf(evt.getKeyChar()), modifiers);
