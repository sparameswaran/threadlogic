...
public abstract class InputHandler extends KeyAdapter {
   ...
   *          The action command
   */
  public void executeAction(ActionListener listener, Object source, String actionCommand, int modifiers) {
    // create event
  ...
  protected void handleGrabAction(KeyEvent evt) {
    ...
    grabAction = null;
    executeAction(_grabAction, evt.getSource(), String.valueOf(evt.getKeyChar()), evt.getModifiers());
  }
